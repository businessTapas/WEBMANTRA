...
<!-- Mirrored from themesflat.co/html/modave/shop-default-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Apr 2025 07:37:04 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="wrap-recommendations">
                        <div class="list-cart">
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload" data-src="{{('frontend/images/products/womens/women-1.jpg')}}" src="{{('frontend/images/products/womens/women-1.jpg')}}" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                            ...
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload" data-src="{{('frontend/images/products/womens/women-2.jpg')}}" src="{{('frontend/images/products/womens/women-2.jpg')}}" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                            ...
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload" data-src="{{('frontend/images/products/womens/women-3.jpg')}}" src="{{('frontend/images/products/womens/women-3.jpg')}}" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                            ...
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload" data-src="{{('frontend/images/products/womens/women-4.jpg')}}" src="{{('frontend/images/products/womens/women-4.jpg')}}" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                                        <a class="link text-line-clamp-1" href="product-detail.html">Belt wrap dress</a>
                            ...
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload" data-src="{{('frontend/images/products/womens/women-5.jpg')}}" src="{{('frontend/images/products/womens/women-5.jpg')}}" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                                        <a class="link text-line-clamp-1" href="product-detail.html">Belt wrap dress</a>
                            ...
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload" data-src="{{('frontend/images/products/womens/women-6.jpg')}}" src="{{('frontend/images/products/womens/women-6.jpg')}}" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                                        <a class="link text-line-clamp-1" href="product-detail.html">Belt wrap dress</a>
                                    ...
                                    <div class="tf-mini-cart-items">
                                        <div class="tf-mini-cart-item file-delete">
                                            <div class="tf-mini-cart-image">
                                                <img class="lazyload" data-src="{{('frontend/images/products/womens/women-19.jpg')}}" src="{{('frontend/images/products/womens/women-19.jpg')}}" alt="">
                                            </div>
                ...
                <div>
                    <div class="tf-product-info-list">
                        <div class="tf-product-info-item">
                            <div class="image">
                                <img src="{{('frontend/images/products/womens/women-1.jpg')}}" alt="">
                            </div>
                            <div class="content">
...
<!-- Mirrored from themesflat.co/html/modave/shop-default-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Apr 2025 07:37:12 GMT -->
</html>